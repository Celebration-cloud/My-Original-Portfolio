  ...
  return (
    ...
    >
      <div className="inner carousel-inner">
        <div className="countUp carousel-item active" data-bs-interval="5000">
          <i className="fa-solid fa-rocket fa-3x"></i>
          <h4>Projects Achieved</h4>
          <h2 className="number">100</h2>
        </div>
        <div className="countUp carousel-item" data-bs-interval="5000">
          <i className="fa-solid fa-trophy fa-3x"></i>
          <h4>Award win</h4>
          <h2 className="number">100</h2>
        </div>
        <div className="countUp carousel-item" data-bs-interval="10000">
